    ...
    public partial class 文件关键字检索 : Form
    {
        ...
        public void Director(string dir)
        {
            try
            {
                ...
                {
                    ListViewItem item2 = listView1.Items.Add(new ListViewItem(new string[] { (listView1.Items.Count + 1).ToString(), dir + "\\" + f.Name, Path.GetExtension(f.Name), "","" }));
        ...
        private void 选择文件ToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // openFileDialog1.Filter = "excel07文件(*.xlsx)|*.xlsx";
            ...
            {
                //打开文件对话框选择的文件
                ListViewItem item2 = listView1.Items.Add(new ListViewItem(new string[] { (listView1.Items.Count + 1).ToString(), openFileDialog1.FileName, Path.GetExtension(openFileDialog1.FileName), "", "" }));
