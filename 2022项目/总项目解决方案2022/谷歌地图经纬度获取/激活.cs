...
namespace 谷歌地图经纬度获取
{
    public partial class 激活 : Form
    {
        ...
        {
            string jihuoma = method.GetMD5(textBox1.Text.Trim()+"siyiruanjian");
            if (textBox2.Text.Length > 32)
            {
                MessageBox.Show(jihuoma);
        ...
        private void 激活_FormClosing(object sender, FormClosingEventArgs e)
        {
