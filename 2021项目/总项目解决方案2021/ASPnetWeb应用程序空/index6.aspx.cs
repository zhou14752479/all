    ...
    public partial class index6 : System.Web.UI.Page
    {
        ...
        public void run(string changci, string value)
        {
            ...
            try
            {
                ...
                Bitmap bitmap = new Bitmap(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/main6/" + value + ".jpg");
                Graphics device = Graphics.FromImage(bitmap);
                //如果picturebox1本身有内容，就先画到image上
                device.DrawImage(image_changci, 400, 20); //用你想要的位置画小图
                ...
                bitmap.Save(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/" + changci + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
        ...
        {
            System.Drawing.Image img1 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/1.jpg");
            Bitmap map1 = new Bitmap(img1);
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/2.jpg");
            ...
            //保存
            img.Save(Path.Combine(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/result.jpg"));
            img.Dispose();
        ...
        static private void CombinImage3()
        {
            ...
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/2.jpg");
            Bitmap map2 = new Bitmap(img2);
            System.Drawing.Image img3 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/3.jpg");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                StreamReader sr = new StreamReader(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/index6.txt", Encoding.GetEncoding("UTF-8"));
                //一次性读取完 
            ...
            {
                if (File.Exists(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/result.jpg"))
                {
                    File.Delete(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/result.jpg");
                }
            }
            if (HttpContext.Current.Request.RequestType == "POST")
            {
                ...
                FileStream fs1 = new FileStream(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/index6.txt", FileMode.Create, FileAccess.Write);//创建写入文件 
                ...
                if (diyichang != "")
                {
                    ...
                    File.Copy(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/1.jpg", AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image6/result.jpg");
                }
