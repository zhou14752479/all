...
namespace 美团
{
    public partial class 美团附近 : Form
    {
        ...
        Dictionary<string, string> pingfen_dic = new Dictionary<string, string>();
        #region  主程序爬取神灯详情页
...

                            {
                               ...
                               // textBox2.Text = html;
                                ...
                                for (int z = 0; z < uids.Count; z++)
                                {
                                 ...
                                 if(!pingfen_dic.ContainsKey(uids[z].Groups[1].Value))
                                    {
                                        pingfen_dic.Add(uids[z].Groups[1].Value,shopPowers[z].Groups[1].Value);
                                    }
