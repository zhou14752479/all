    ...
    public partial class index7 : System.Web.UI.Page
    {
        ...
        public void run(string changci, string value)
        {
            ...
            try
            {
                ...
                device.DrawImage(image_changci, 370, 50); //用你想要的位置画小图
                ...
                bitmap.Save(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/" + changci + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
        ...
        {
            System.Drawing.Image img1 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/1.jpg");
            Bitmap map1 = new Bitmap(img1);
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/2.jpg");
            ...
            //保存
            img.Save(Path.Combine(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/result.jpg"));
            img.Dispose();
        ...
        static private void CombinImage3()
        {
            ...
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/2.jpg");
            Bitmap map2 = new Bitmap(img2);
            System.Drawing.Image img3 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/3.jpg");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (File.Exists(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/result.jpg"))
                {
                    File.Delete(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/result.jpg");
                }
            }
            if (HttpContext.Current.Request.RequestType == "POST")
            {
                ...
                if (diyichang != "")
                {
                    ...
                    File.Copy(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/1.jpg", AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/image7/result.jpg");
                }
