    ...
    public partial class 虎牙种豆 : Form
    {
        ...
        public void run()
        {
            ...
            for (int page = 1; page < 9999; page++)
            {
                ...
                string url = "https://i.huya.com/index.php?m=MatchGuess&do=ajaxGetGuessHistory&page=" + page + "&transType=2";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            selectcookie = (listView1.SelectedItems[0].SubItems[2].Text);
        ...
        private void 虎牙种豆_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                {
                    sb.Append(listView1.Items[i].SubItems[1].Text+ "####"+listView1.Items[i].SubItems[2].Text+"----");
                }
