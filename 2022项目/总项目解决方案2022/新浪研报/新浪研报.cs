            ...
            try
            {
                ...
                for (int a = 1; a < text.Length; a++)
                {
                    ...
                    for (int page = 1; page < 100; page++)
                    {
                        ...
                        string html = method.GetUrlwithIP(url, "tps682.kdlapi.com:15818", "", "gb2312");
                        ...
                        for (int i = 0; i < uids.Count; i++)
                        {
                            ...
                            string ahtml = method.GetUrlwithIP(aurl, "tps682.kdlapi.com:15818", "", "gb2312");
