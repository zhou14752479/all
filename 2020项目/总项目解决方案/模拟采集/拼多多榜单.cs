...
namespace 模拟采集
{
    public partial class 拼多多榜单 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string url = "https://mobile.yangkeduo.com/proxy/api/api/george/content/query_content_list?pdduid=7312500755985&is_back=1&size=200&resource_type=1&tab_id="+bId+"&page=1&obj_count=2&type="+cId+"&list_id="+aId+"_"+bId+"_"+cId+"_hDET3469Bd&field_types=content_goods_material";
            string html = method.GetUrlWithCookie(url,cookie,"utf-8");
            ...
            for (int i = 0; i < listIds.Count; i++)
            {
                ...
                status = false;
                webBrowser1.Navigate("https://mobile.yangkeduo.com/sjs_cat_rank_list.html?scene_id=list_channel_rank_category&_pdd_fs=1&_pdd_tc=ffffff&_pdd_sbs=1&refer_page_el_sn=3408901&list_id="+listIds[i].Groups[1].Value+"&entrance_type=1&refer_origin_page_sn=17542&refer_first_tab_id=39246&refer_second_tab_id=39611&refer_page_name=list_classification&refer_page_id=67388_1599522932540_mqxy6u9gbl&refer_page_sn=67388&refer_abtest_info=%7B%7D&activeTab="+tap);
