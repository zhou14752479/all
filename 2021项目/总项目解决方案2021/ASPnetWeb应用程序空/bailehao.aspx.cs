...
{
    public partial class bailehao : System.Web.UI.Page
    {
        /// <summary>
        /// 读取本地图片
        /// </summary>
        ...
        public void run(string changci, string value)
        {
            ...
            try
            {
                ...
                Bitmap bitmap = new Bitmap(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao_main/"+changci+"/" + value + ".jpg");
                Graphics device = Graphics.FromImage(bitmap);
                //如果picturebox1本身有内容，就先画到image上
             

                device.DrawImage(image_month, 230, 115);
                device.DrawImage(image_month2, 245, 115);

                device.DrawImage(image_day, 285, 115);
                device.DrawImage(image_day2, 300, 115);



                device.DrawImage(image_yue, 185, 76);
                device.DrawImage(image_ri, 255, 76);


                bitmap.Save(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/" + changci + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
        ...
        {
            System.Drawing.Image img1 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/1.jpg");
            Bitmap map1 = new Bitmap(img1);
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/2.jpg");
            ...
            //保存
            img.Save(Path.Combine(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/result.jpg"));
            img.Dispose();
        ...
        static private void CombinImage3()
        {
            ...
            System.Drawing.Image img2 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/2.jpg");
            Bitmap map2 = new Bitmap(img2);
            System.Drawing.Image img3 = System.Drawing.Image.FromFile(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/3.jpg");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                StreamReader sr = new StreamReader(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao.txt", Encoding.GetEncoding("UTF-8"));
                //一次性读取完 
            ...
            {
                if (File.Exists(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/result.jpg"))
                {
                    File.Delete(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/result.jpg");
                }
            }
            if (HttpContext.Current.Request.RequestType == "POST")
            {
                ...
                FileStream fs1 = new FileStream(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao.txt", FileMode.Create, FileAccess.Write);//创建写入文件 
                ...
                if (diyichang != "")
                {
                    ...
                    File.Copy(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/1.jpg", AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/bailehao/result.jpg");
                }
