...
namespace 孔夫子APP
{
    public partial class 孔夫子APP带定价 : Form
    {
        public 孔夫子APP带定价()
        {
            InitializeComponent();
        ...
        private void 孔夫子APP带定价_FormClosing(object sender, FormClosingEventArgs e)
        {
                ...
                for (int page = 1; page < 9999; page++)
                {
                    try
                    {
                        ...
                        for (int j = 0; j < names.Count; j++)
                        {
                            ...
                            ListViewItem lv1 = listView1.Items.Add((listView1.Items.Count + 1).ToString()); //使用Listview展示数
                            try
                            {
                            ...
                            Thread t = new Thread(() =>
                            {
                                try
                                {
                                    ...
                                    string postdata2 = "User-Agent=IOS_KFZ_COM_4.1.1_iPhone14%2C5_15.6%20%23App%20Store%2C6FB137584B08435A8842DEF8F4E8D38E&UserAgent=IOS_KFZ_COM_4.1.1_iPhone14%2C5_15.6%20%23App%20Store%2C6FB137584B08435A8842DEF8F4E8D38E&access-token=cd494818-91d8-4c7b-94a3-aa44a05d31c9&appName=IOS_KFZ_COM&appVersion=IOS_KFZ_COM_iOS_4.1.1&itemId=" + itemids[j].Groups[1].Value + "&shopId=" + shopid + "&ssid=1660117249000363970&token=cd494818-91d8-4c7b-94a3-aa44a05d31c9&utmSource=App%20Store&uuid=6FB137584B08435A8842DEF8F4E8D38E";

                                    string bhtml = PostUrlDefault("https://app.kongfz.com/invokeBook/app/api/getItemInfo", postdata2, "");
