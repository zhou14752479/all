        ...
        public void a360()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < 10; i++)
                {
                    ...
                    MatchCollection urls = Regex.Matches(html, @"<a class=""e-more-see-detail"" href=""([\s\S]*?)""", RegexOptions.IgnoreCase | RegexOptions.Multiline);
                    MatchCollection bs = Regex.Matches(html, @"<span class='res-site-url'>([\s\S]*?)</span>", RegexOptions.IgnoreCase | RegexOptions.Multiline);
        ...
        public void shenma()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    MatchCollection urls = Regex.Matches(html, @"data-lp=""([\s\S]*?)""", RegexOptions.IgnoreCase | RegexOptions.Multiline);
                    MatchCollection bs = Regex.Matches(html, @"<div class=""other"">([\s\S]*?)</div>", RegexOptions.IgnoreCase | RegexOptions.Multiline);
