...
namespace 天猫店铺采集
{
    public partial class 天猫店铺采集 : Form
    {
      ...
      public static List<string> cookielist = new List<string>();
        ...
        //string reviewcookie = "enc=HYxeMUeTzCthhdPIdLk0WU7%2Fs2GTWjmKTCc5HJfIS%2BbcjvBNH6zITVSd2Ld0w8jbIvuevTcpWUHeEY2DSUG6pw%3D%3D; thw=cn; useNativeIM=false; wk_cookie2=1b141ab5e69eeed07ee3f4817c5a5bfc; ariaDefaultTheme=undefined; t=c64f2677bd110275067a52097d9a82fe; havana_lgc_exp=1752320077579; wk_unb=UoH62EAv27BqSg%3D%3D; xlly_s=1; mt=ci=0_0; cna=MzhRHcr39U0CAXniuQ8rE6eU; lgc=zkg852266010; dnk=zkg852266010; tracknick=zkg852266010; _samesite_flag_=true; sdkSilent=1721784760266; cookie2=2af461e05bcbdffbf3e3cee5572c4d13; _tb_token_=f3a978ee3388f; mtop_partitioned_detect=1; _m_h5_tk=b966873b12a12405a61e58e2e6c8415c_1721708801819; _m_h5_tk_enc=de5b98462037fd863cafc9831ea04907; 3PcFlag=1721698361867; sgcookie=E100Qldv4n5uyDERmXwgxO0xfZXPVtR5g81hjJMwHjBIh2q6OVrnaQFTf0uFBSrHqtazXU2UG%2F3z2%2FjTXDoeMv6rX9ACZ%2B0fPsWP0UDwAEaDdE1A8y%2B%2BLETCxoD62BVnSO2R; unb=1052347548; uc3=nk2=GcOvCmiKUSBXqZNU&vt3=F8dD3ijBRDz4pkpln80%3D&lg2=UtASsssmOIJ0bQ%3D%3D&id2=UoH62EAv27BqSg%3D%3D; csg=acf94838; cancelledSubSites=empty; cookie17=UoH62EAv27BqSg%3D%3D; skt=17ea12301f25bc51; existShop=MTcyMTY5ODM2NA%3D%3D; uc4=nk4=0%40GwrkntVPltPB9cR46GndwoUpp7xY%2Fqs%3D&id4=0%40UOnlZ%2FcoxCrIUsehKuaS0pv%2FlOmV; _cc_=UtASsssmfA%3D%3D; _l_g_=Ug%3D%3D; sg=080; _nk_=zkg852266010; cookie1=Vvj8uMJubtxirKFtxaDmWPxYCP5sb7EKtrFe1w68JDk%3D; tfstk=f--pbVTT2fcHVNgRlv3MEnXFd8MMJHpetBJbq_f3PCd9t1qoLM0P2QC9a6bhApmWsBvjL60r8QeeXIEuxXueFuIlVjcmmmvELgSSiKGdZM1FUd1W6gBw4pSPVf2gVqmvLI3wwbgMdcE47vPr6uxkJ9iLp3_YKExdpwC8q1E8fYXdJspC6jGXX07dGp1TVj4Cw7fR_nGiWd-pRBXwwmhO4C8WNTd_1bbeFFdOpBcYa_xeK3Bwp2GpBG1d0HTYeuJOv6Kl5NyY26sMQN_ef7reB3CdlH_TeYvAATO5yFlYm9IHWZKp8YP6dIfplMJuHXvOkFQVCNw8RMYDn37XADFVsZWJt1AjclI1Pg72mn3n8SfAEyMtBzzPRO5rHK6iZapLUOCmdwazzaXNBsDtBzzPROWOivZ7zz7lQ; uc1=cookie16=UtASsssmPlP%2Ff1IHDsDaPRu%2BPw%3D%3D&pas=0&cookie15=WqG3DMC9VAQiUQ%3D%3D&cookie14=UoYcAjdFPfN47g%3D%3D&cookie21=V32FPkk%2Fhodroid0QSjisQ%3D%3D&existShop=true; isg=BGxsu2JYJqDK-DKE0sC90aY2PUqeJRDPDFrt2catVpe60Q7b7DH0Xp1z85npwkgn";
        List<string> list = new List<string>();
                        ...
                        for (int j = 0; j < title.Count; j++)
                        {
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    textBox4.Text += DateTime.Now.ToString("HH:mm:dd") + "->页码"+ i+"  "+keyword+" "+ shopname + " 商品销量：" + goodsold + " 不符合要求跳过..." + "\r\n";
                                }
