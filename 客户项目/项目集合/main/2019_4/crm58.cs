...
namespace main._2019_4
{
    public partial class crm58 : Form
    {
        ...
        public  void getTags()
        {
            string html = method.GetUrlWithCookie("http://s.crm.58.com/OppTag/GetFrequentTags", COOKIE);
        ...
        public static string COOKIE = "crm.auth=zgGHwN9DjQfZ63JVqZGUxhEfFlOJj9dy8HcB81s_8Ryn8qYTzLdn-_Cjdq5JvVSK; crm.sostoken=zgGHwN9DjQfbIxvgMnTaNw; ASP.NET_SessionId=35as4x4s2bvghf2zlfnxrthg";
        #region  crm58库
...
"D8F441FF-799D-41AD-9791-D5E5583B0EDB",
        ...
        private void 添加到标签ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            textBox1.Text= method.PostUrl(url, postData, COOKIE, "utf-8");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in listView1.Items)
            {
                ...
                string postData = "oppid=" + item.SubItems[4].Text + "&source=%E4%BB%8A%E6%97%A5%E9%87%8A%E6%94%BE%E9%A2%84%E5%91%8A&tagName=" + tagname;
                 status = method.PostUrl(url, postData, COOKIE, "utf-8");
