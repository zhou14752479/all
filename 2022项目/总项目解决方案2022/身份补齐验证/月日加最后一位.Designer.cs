namespace 身份补齐验证
{
    ...
    "b=1";
            ...
            this.Text = "月日加最后一位";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.月日加最后一位_FormClosing);
            this.Load += new System.EventHandler(this.月日加最后一位_Load);
