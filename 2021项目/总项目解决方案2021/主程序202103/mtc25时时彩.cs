    ...
    public partial class mtc25时时彩 : Form
    {
        ...
        public void taiwanbinguo8()
        {
            ...
            for (DateTime dt = dateTimePicker1.Value; dt < dateTimePicker2.Value; dt = dt.AddDays(1))
            {
                ...
                string url = "https://api.365kaik.com/api/v1/trend/getHistoryList?t=1628381966&lotCode=10032&date=" + dt.ToString("yyyy-MM-dd") + "&pageSize=2000&pageNum=0";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                thread = new Thread(taiwanbinguo8);
                thread.Start();
