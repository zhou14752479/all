    ...
    public partial class 教育视频网 : Form
    {
        ...
        private void listBox1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (listBox1.SelectedIndex != -1)
            {
               ...
               axWebBrowser1.Navigate("http://1s1k.eduyun.cn/resource/redesign/publishCase/vod_player.jsp?resourceCode=mda-" + value.Groups[1].Value + "&divId=playercontainers1&wid=770&hei=530&sessionKey=KTHObD76L5EyEDjLsWWu");
