...
namespace 身份补齐验证
{
    public partial class 月日加最后一位 : Form
    {
        public 月日加最后一位()
        {
            InitializeComponent();
        ...
        #endregion
        private void 月日加最后一位_Load(object sender, EventArgs e)
        {
            #region 通用检测
        ...
        private void 月日加最后一位_FormClosing(object sender, FormClosingEventArgs e)
        {
