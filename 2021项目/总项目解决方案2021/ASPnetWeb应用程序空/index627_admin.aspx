<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index627_admin.aspx.cs" Inherits="ASPnetWeb应用程序空.index627_admin" %>
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1, user-scalable=no" /><meta http-equiv="Cache-Control" content="no-cache" /><meta http-equiv="Pragma" content="no-cache" /><title>
    ...
    <script>
         function goto(changci) {
            window.location.href = "index627_admin.aspx?changci=" + changci;
        }
        function resetdata() {
         ...
         <button type="button" class="button button-block top10 bottom10" onclick="goto(3);">设置第三场</button>
          ...
          <div class="w50 center">
            ...
            <div class="border">
                ...
                <div class="w80 center">
                    <div class="text-style top10">
                        <input type="text" name="zuori"   value="<%=Application["zuori"]%>" placeholder="昨日开奖" />
                    </div>
                     <div class="text-style top10">
                    ...
                    <div class="text-style top10">
                     ...
                     <div class="text-style top10">
                      ...
                      <div class="text-style top10">
                        <input type="text" name="a5" value="<%=Application["a5"]%>" placeholder="第三句" />  
                    </div>
                    <div class="text-style top10">
                        <input type="text" name="a6" value="<%=Application["a6"]%>" placeholder="第四句" />
                       
                    </div>
                    <div class="text-style top10">
                        <input type="text" name="a7" value="<%=Application["a7"]%>" placeholder="第五句" />
