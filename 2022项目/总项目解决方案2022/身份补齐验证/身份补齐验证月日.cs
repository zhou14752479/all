...
namespace 身份补齐验证
{
    public partial class 身份补齐验证月日 : Form
    {
        public 身份补齐验证月日()
        {
            InitializeComponent();
                        ...
                        for (int day = 1; day <= 31; day++)
                        {
                            ...
                            if (astatus == "0")
                            {
                                ...
                                else
                                {
                                    ...
                                    System.TimeSpan t = DateTime.Now - starttime;
                                    label4.Text = "运行用时：" + t.Hours + "时" + t.Minutes + "分" + t.Seconds + "秒，导入数据数量：" + allcount + " 正在验证第" + runcount + "个，成功数量：" + successcount;
                                    textBox3.Text += value[0] + "----" + card + "----" + amsg + "\r\n";
                                }
        ...
        private void 身份补齐验证月日_Load(object sender, EventArgs e)
        {
            #region 通用检测
        ...
        private void 身份补齐验证月日_FormClosing(object sender, FormClosingEventArgs e)
        {
