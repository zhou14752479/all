<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lanqiu.aspx.cs" Inherits="ASP足球网站.lanqiu" %>
  ...
  <!DOCTYPE html>
        ...
        <div class="hd">
        <div class="logo">
        <a class="subtitle" href="">篮球数据查询</a>
        </div>
        <div class="menu" data-name="篮球让分"></div>
...
<div class="bd">
    ...
    <table style="box-sizing:border-box;">
        ...
        <th><strong>联赛</strong></th>
        <th><strong>主队</strong></th>
        <th><strong>客队</strong></th>
        <th><strong>让分</strong></th>
...
<button type="button" onclick="buy()" style="width:100%;height:30px;margin-top:10px; background:#2095f2;color:#fff;border:medium none;" >保存</button>
        ...
        <th><strong>主队</strong></th>
        <th><strong>客队</strong></th>
        <th><strong>主比分</strong></th>
        <th><strong>客比分</strong></th>
        <th><strong>让分</strong></th>
         <th><strong>赔率</strong></th>
        </tr>
        </thead>
